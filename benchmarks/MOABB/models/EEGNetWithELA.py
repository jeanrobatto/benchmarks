"""
Base Model: EEGNet from https://doi.org/10.1088/1741-2552/aace8c.
...
NOTE - This is a modified version of the standard EEGNet model.
...
class EEGNetWithELA(torch.nn.Module):
    """EEGNetWithELA.
    ...
    #>>> model = EEGNetWithELA(input_shape=inp_tensor.shape)
